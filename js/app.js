const ingresos = [new Ingreso("Salario", 60000.0)];
...
let cargarCabecero = () => {
  ...
  document.getElementById("porcentajeIngreso").innerHTML =
    formatoPorcentaje(porcentajeIngreso);
};
